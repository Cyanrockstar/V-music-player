...
app = Tk()
app.title('V-music-player made in Python')
...
menu_bar.add_cascade(label='Add music folder +', menu=add_songs_menu)

# Create a listbox to display songs
song_listbox = Listbox(app, bg="chocolate", fg="white", width=100, height=13)
song_listbox.pack()
